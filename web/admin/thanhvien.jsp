                    ...
                    <form class="form-horizontal form-label-left " method="POST" action="${pageContext.request.contextPath}/admin/thanhvien">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                <input type="text" name="tendangnhap" value="${thanhVienModel != null ? thanhVienModel.getTenDangNhap():""}" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                <input type="password" autocomplete="new-password" name="matkhau" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                <input type="password" autocomplete="new-password" name="laplaimatkhau" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Họ tên</label>
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                <input type="text" name="hoten" value="${thanhVienModel != null ? thanhVienModel.getHoTen():""}" required="required"  class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Địa chỉ</label>
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                <input type="text" name="diachi" value="${thanhVienModel != null ? thanhVienModel.getDiaChi():""}" required="required"  class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Số điện thoại</label>
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                <input type="text" name="sodienthoai" value="${thanhVienModel != null ? thanhVienModel.getSoDienThoai():""}" class="form-control col-md-7 col-xs-12"required="required" onkeypress="return event.charCode >= 48 && event.charCode <= 57" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                <input type="email" name="email" value="${thanhVienModel != null ? thanhVienModel.getEmail():""}" class="form-control col-md-7 col-xs-12" required="required" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                ...
                                <select id="heard" class="form-control" required="" name="phanquyen">
                                    ...
                                    <c:forEach items="${listAllPhanQuyen}" var="obj">
                                        <option ${thanhVienModel != null && thanhVienModel.getMaPhanQuyen() == obj.getMaPhanQuyen() ? "selected" : ""} value="${obj.getMaPhanQuyen()}">${obj.getTenQuyen()}</option>
