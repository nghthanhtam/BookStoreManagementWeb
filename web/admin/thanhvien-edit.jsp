                    ...
                    <form class="form-horizontal form-label-left " method="POST" action="${pageContext.request.contextPath}/admin/thanhvien/edit">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-9 col-xs-12">
                          <input type="text" name="tendangnhap" readonly required="required" value="${thanhVienModel.getTenDangNhap()}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-9 col-xs-12">
                            <input type="password" autocomplete="new-password" name="matkhau"  placeholder="Bỏ trống nếu không thay đổi mật khẩu" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                        <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-9 col-xs-12">
                            <input type="password" autocomplete="new-password" name="laplaimatkhau"  placeholder="Bỏ trống nếu không thay đổi mật khẩu" value="" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                        <div class="form-group">
