                ...
                <div class="x_content">
                    ...
                    <form  class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/sach/add">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-9 col-xs-12">
                                <input type="text" maxlength="5" id="phantramgiamgia" onkeyup="kiemTraHienThiInputThoiGianGiamGia()"  name="phantramgiamgia" class="form-control col-md-7 col-xs-12" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 46))">
                            </div>
                        </div>
                        ...
                        <script>
                            function kiemTraHienThiInputThoiGianGiamGia() { 
                                ...
                                if (document.getElementById("phantramgiamgia").value == "")
                                {
                        ...
                        <div class="form-group" id="formkhoangthoigiangiamgia" style="display:none">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="input-prepend input-group">
                                                ...
                                                <input type="text" name="khoangthoigiangiamgia" id="reservation" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
