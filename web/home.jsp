					...
					<div class="product product-single product-hot">
						...
						<div class="product-body">
							...
							<div class="product-btns">
								...
								<button class="primary-btn add-to-cart" data-id="${sachGiamGiaNhat.getMaSach()}" data-name="${sachGiamGiaNhat.getTenSach()}" data-price="${sachGiamGiaNhat.getGiaBan()}"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
